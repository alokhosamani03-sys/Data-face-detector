...
# Core Cyberpunk Engine & Floating Animations
st.markdown("""
<style>
    ...
    /* FIX: Changed z-index from -1 to 999 so it floats IN FRONT of the background */
    .cyber-particles {
        position: fixed;
        top: 0; left: 0; width: 100vw; height: 100vh;
        z-index: 999; 
        pointer-events: none; /* Allows clicking through the floating text */
        overflow: hidden;
    }
    ...
    /* Individual element physics */
    .p1 { left: 5%; font-size: 1.5rem; animation-duration: 10s; animation-delay: 0s; }
    .p2 { left: 25%; font-size: 1.2rem; animation-duration: 7s; animation-delay: 2s; color: rgba(255, 0, 255, 0.6); text-shadow: 0 0 10px #FF00FF; }
    .p3 { left: 45%; font-size: 2rem; animation-duration: 14s; animation-delay: 1s; }
    .p4 { left: 60%; font-size: 1.1rem; animation-duration: 9s; animation-delay: 5s; }
    .p5 { left: 75%; font-size: 1.8rem; animation-duration: 12s; animation-delay: 3s; color: rgba(255, 0, 122, 0.6); }
    .p6 { left: 85%; font-size: 1.4rem; animation-duration: 8s; animation-delay: 0s; }
    .p7 { left: 95%; font-size: 1.6rem; animation-duration: 11s; animation-delay: 4s; }

    /* The Flying/Falling Keyframe */
    @keyframes fall {
        0% { transform: translate(-30px, -10vh) rotate(0deg); opacity: 0; }
        10% { opacity: 1; }
        90% { opacity: 1; }
    ...
    @keyframes floatHolo {
        0%, 100% { transform: translateY(0px); box-shadow: 0 5px 15px rgba(0, 255, 255, 0.1); }
        50% { transform: translateY(-6px); box-shadow: 0 15px 25px rgba(0, 255, 255, 0.3); }
    }
    ...
    div[data-testid="stFileUploader"]:hover, div[data-testid="stCameraInput"]:hover {
        ...
        box-shadow: inset 0 0 30px rgba(0,255,255,0.2), 0 0 15px rgba(0,255,255,0.4);
    }
