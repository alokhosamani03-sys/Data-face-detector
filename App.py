...
# Core Cyberpunk Engine & Floating Face Animations
st.markdown("""
<style>
    ...
    /* Base styling for falling tech elements */
    .particle {
        position: absolute;
    ...
    /* Roaming Bounding Boxes (Face Detection Simulation) */
    .roam-box {
        position: absolute;
    ...
    .roam-box-2 {
        ...
        animation: roam2 25s ease-in-out infinite alternate-reverse;
        color: rgba(255, 0, 122, 0.2);
    }

    /* Miniature laser scanners inside the roaming boxes */
    .roam-box::after, .roam-box-2::after {
        content: '';
        position: absolute;
...
<!-- Injecting Floating Cyber Faces and Roaming Detectors -->
<div class="cyber-particles">
    <!-- Roaming Background Scanners -->
